...
const posts = [
  ...
  {
    slug: "best-b2b-appointment-setting-agencies",
    title: "Best B2B Appointment Setting Agencies in 2026 (Ranked & Reviewed)",
    description: "A ranked list of the best B2B appointment setting agencies in 2026 — compared by pricing, setup time, channels, and who they're built for.",
    date: "March 30, 2026",
    readTime: "10 min read",
  ...
  {
    slug: "best-cold-email-agency-for-b2b-saas",
    title: "Best Cold Email Agency for B2B SaaS (2026): Ranked & Reviewed",
    description: "The top cold email agencies for B2B SaaS companies in 2026, ranked by results, pricing, and SaaS specialization. Who actually books demos — and who to avoid.",
    date: "April 2, 2026",
    readTime: "9 min read",
    category: "Agency Guide",
    lang: "EN",
  ...
  {
    slug: "is-cold-email-still-effective-2026",
    title: "Is Cold Email Still Effective in 2026? (Honest Answer + Real Data)",
    description: "Cold email open rates, reply rates, and ROI benchmarks for 2026. What works, what doesn't, and what separates campaigns that book meetings from ones that get ignored.",
    date: "April 5, 2026",
    readTime: "8 min read",
    category: "Cold Email",
    lang: "EN",
  ...
  {
    slug: "how-to-get-meetings-with-ceos-and-vps",
    title: "How to Get Meetings with CEOs and VPs Using Cold Email (2026 Guide)",
    description: "A proven playbook for booking sales meetings with C-suite and VP-level executives via cold email and LinkedIn. Includes subject lines, email frameworks, and targeting strategies.",
    date: "April 7, 2026",
    readTime: "10 min read",
  ...
  {
    slug: "why-cold-email-not-getting-replies",
    title: "Why Your Cold Email Is Not Getting Replies (10 Real Reasons + Fixes)",
    description: "You're sending. Nobody's replying. Here are the 10 most common reasons cold email campaigns fail — covering deliverability, copy, targeting, and sequences — with exact fixes for each.",
    date: "April 9, 2026",
    readTime: "8 min read",
